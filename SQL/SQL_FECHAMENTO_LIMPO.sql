-- MIGRATION 1: Tabela de Configuracao de Fechamento de Mes
...
-- MIGRATION 2: Tabela de Historico de Fechamento de Mes
...
-- MIGRATION 3: Adicionar coluna total_consumo_interno na tabela holerites
ALTER TABLE `holerites` 
ADD COLUMN IF NOT EXISTS `total_consumo_interno` decimal(10,2) NOT NULL DEFAULT 0.00 AFTER `total_comissoes`;

-- Inserir configuracoes padrao para cada tenant
