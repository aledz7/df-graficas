// Inline contents from visual-editor-config.js to avoid 404 errors
const POPUP_STYLES = `
#inline-editor-popup {
  width: 360px;
  position: fixed;
...
#inline-editor-popup button.save {
  background: #357DF9;
  color: white;
}

#inline-editor-popup button.cancel {
  background: transparent;
  color: #a0aec0;
}
`;

function getPopupHTMLTemplate(saveLabel, cancelLabel) {
  return `
    <textarea></textarea>
